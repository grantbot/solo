...
function handleImage(req, res) {
  ...
  //TODO: Find where api_key is set, then set headers there too
  //see: http://www.alchemyapi.com/api/face-detection/image.html
